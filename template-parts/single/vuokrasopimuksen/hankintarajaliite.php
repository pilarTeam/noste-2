                        ...
                        <div class="">
                            ...
                            <div class="mb-8 mx-auto max-w-full">
                                <div class="flex flex-wrap items-center mb-4">
                                    <label class="flex-[3] md:flex-[.7] lg:flex-[.2] mr-4 text-sm text-accent italic" for="version">Version:</label>
                                            ...
                                            <div class="overflow-hidden">
                                                <table class="w-full whitespace-nowrap border-collapse">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="px-4 py-3 border border-line">
                                                                <input class="shadow-input mr-3 relative appearance-none rounded border cursor-pointer border-accent checked:border-accent checked:after:content-['\2713'] checked:after:text-primary checked:after:absolute checked:after:top-1/2 checked:after:left-1/2 checked:after:-translate-x-1/2 checked:after:-translate-y-1/2 h-5 w-2 p-2" type="checkbox" <?php noste_checkbox_attrset('coder_attention266'); ?>>
                                                            </td>
                                                            <td class="px-4 py-3 border border-line">
